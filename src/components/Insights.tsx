  ...
  return <section id="insights" className="pb-16 md:pb-20">
      <div className="container mx-auto px-6">
        ...
        <p className="text-muted-foreground mb-8">
          The most effective digital ministries don't just collect data—they act on it. FaithTech.dev helps churches, non-profits, and Bible organizations transform analytics into actionable insights that drive engagement, growth, and impact. With deep experience at the intersection of faith and technology, I translate numbers into next steps, so your mission moves forward with clarity and purpose.
        </p>
